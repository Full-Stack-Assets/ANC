...
| Italy + East Mediterranean (Central Italy 7 + Cyprus 2 + Levant 1) | ~10% | 12.5% (Angelo Prospero + Vincenza Minochelli) | **Consistent within recombination variance** — central/southern Italian ancestry routinely reads partly as Cyprus/Levant. Update 2026-07-03: the Mary Prosper question is RESOLVED by SS-5 records — Vincenza was her mother (the 1906 death was mis-attached), so the 12.5% Italian paper expectation stands as-is. |
